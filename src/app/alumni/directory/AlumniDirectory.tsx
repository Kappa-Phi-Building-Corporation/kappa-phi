  ...
  return (
    <div className="flex h-full">
        ...
        {view === 'list' && <div className="overflow-y-auto flex-1 min-h-0">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-kp-border/40">
              ...
              {visible.length === 0 && (
                <tr>
                  <td colSpan={isAdmin ? 4 : 3} className="px-4 py-10 text-center text-gray-500 text-sm">
                    No members found.
                  </td>
                </tr>
              )}
          ...
          <div className="shrink-0 px-4 py-3 border-t border-kp-border flex items-center justify-between gap-2">
            ...
            <div className="flex gap-1 flex-wrap justify-center">
              {pageRange(page, pageCount).map((p, i) =>
                p === '…'
                  ? <span key={`ellipsis-${i}`} className="px-1 text-gray-500 text-xs self-center">…</span>
                  : (
                    <button
                      key={p}
      ...
      {selected ? (
        ...
        <div className="hidden lg:flex flex-1 items-center justify-center text-gray-500 text-sm">
