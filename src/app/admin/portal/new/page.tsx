...
import { createPortalResource } from '../actions'
import ResourceForm from '../ResourceForm'

export const metadata = { title: 'Add Portal Resource' }

export default async function NewPortalResourcePage() {
